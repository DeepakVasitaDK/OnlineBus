                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <div id="loginform" class="form-horizontal" role="form">
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <asp:RegularExpressionValidator ID="regexmail" runat="server" ErrorMessage="Please Enter valid email id format" Display="None" ValidationGroup="vgLogin" ControlToValidate="txtUserId" CssClass="text-danger" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                <br />
                            </div>
                            <div style="margin-bottom: 25px" class="input-group">
